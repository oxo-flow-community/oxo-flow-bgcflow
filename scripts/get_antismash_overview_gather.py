...
def gather_bgc_overview(input_json, mapping_dir, table):
    ...
    # antismash only writes the similarity column when a region matched
    # MIBiG — tiny/novel fixtures have none, and the unguarded apply
    # dies with KeyError: 'similarity' (live, exit-0-but-missing-output)
